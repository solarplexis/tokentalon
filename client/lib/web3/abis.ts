 ...
 * These are minimal ABIs containing only the functions needed by the frontend
 */
...
export const CLAWMACHINE_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'string', name: 'replayDataHash', type: 'string' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'grabNumber', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes32', name: 'voucherHash', type: 'bytes32' },
    ],
    name: 'PrizeClaimed',
    type: 'event',
  },
